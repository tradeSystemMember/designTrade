...
public class BuyHistoryController {
    ...
    @ResponseBody
    public Map<String,Object> getBuyHistoryData(HttpServletRequest request, Integer pageIndex, Integer pageSize){
        User user = (User) request.getSession().getAttribute("user");
        Integer uid = user.getId();
        Map<String,Object> map = new HashMap<>();
        IPage<Sucai> sucaiIPage = buyHistorySerive.selectDownLoadByUid(uid, pageIndex, pageSize);
