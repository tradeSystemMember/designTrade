...
public interface CollectMapper {
    ...
    @Select("select * from sucai where id in (select sucaiid from fav where userid = #{uid}) limit #{pageIndex},#{pageSize}")
    List<Sucai> selectFavByUid(Integer uid, Integer pageIndex, Integer pageSize);
}
